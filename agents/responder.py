...
async def generate_response(
    ...
    if is_escalated:
        escalation_messages = {
            "fr": "Je comprends votre demande. Je transmets à notre équipe qui vous contactera rapidement. Merci 🙏",
            "wo": "Yëgël naa la. Dinaa la jëfandikoo ak team bi. Jërejëf 🙏",
            "ff": "Mi faami ko. Mi yettoo ma e koolol ɗiɗaaɓe 🙏",
            "en": "I understand. Forwarding to our team shortly. Thank you 🙏"
        }
        return {"reply": escalation_messages.get(language, escalation_messages["fr"]), "confidence": 1.0}
...
async def generate_wolof_response(
    ...
    """Réponse en Wolof via Google Gemini 1.5 Flash"""
    try:
...
async def generate_groq_response(
    ...
    """Réponse via Groq pour FR, EN, Pulaar"""
